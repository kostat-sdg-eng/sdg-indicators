...
TARGET_REPO="git@github.com:${TRAVIS_REPO_SLUG}.git"
...
# Keys
openssl aes-256-cbc -K $encrypted_3e6de2a66bf9_key -iv $encrypted_3e6de2a66bf9_iv -in scripts/deploy/keys.tar.enc -out scripts/deploy/keys.tar -d
